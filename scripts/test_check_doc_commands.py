...
class ExtractionTest(unittest.TestCase):
    ...
    def test_it_finds_unquoted_social_image_before_inline_comment(self):
        match = doc.IMAGE_RE.search("image: assets/missing.png # generated by CI")
        self.assertIsNotNone(match)
        self.assertEqual(next(value for value in match.groups() if value), "assets/missing.png")
