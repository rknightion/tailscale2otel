...
def tab_overview():
    ...
    msp = [
        (panel("Tailnets observed", "stat",
               [prom_t("count(count by (tailscale_tailnet) (target_info)) or vector(1)")],
    ...
    scorecard = [
        (panel("Unrestricted ACL rules", "stat",
               [prom_t("sum(sv(%(e)s)) or vector(0)" % {"e": lot("tailscale_acl_unrestricted_rules_ratio", WIN_SLOW)},
                       instant=True)],
               unit="short",
        ...
        (panel("Unapproved subnet routes", "stat",
               [prom_t("max(sv(%(e)s)) or vector(0)" % {"e": lot("tailscale_subnet_routes_unapproved", WIN_SLOW)},
                       instant=True)],
               unit="short",
