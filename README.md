...
[![Go Reference](https://pkg.go.dev/badge/github.com/rknightion/tailscale2otel/v3.svg)](https://pkg.go.dev/github.com/rknightion/tailscale2otel/v3)
...
| **120** shipped rules | **97** alert + **23** recording, Grafana-managed |
...
- **Alerts** — [`deploy/alerts/grafana-managed/`](./deploy/alerts/grafana-managed/) ships **97 alert
  rules and 23 recording rules** (120 total) as `rules.alerting.grafana.app` manifests, one JSON per
